		...
		<div class="row">
			<div class="col-md-4">
				<c:choose>
					...
					<c:otherwise>
						<img
							src="<c:url value="/resources/images/${book.bookImage.originalFilename}"/>"
							style="width: 100%" />
					</c:otherwise>
				</c:choose>
			</div>
			<div class="col-md-8">
				...
				<form:form name="addForm" method="put"
					action="../cart/add/${book.bookId}">
					<p>
						<a href="javascript:addToCart()" class="btn btn-primary">도서주문
							&raquo;</a> <a href="<c:url value='/cart' />" class="btn btn-warning">
							장바구니 &raquo;</a> <a href="<c:url value='/books'/>"
							class="btn btn-secondary">도서 목록 &raquo;</a>
						<sec:authorize url="/books/update">
